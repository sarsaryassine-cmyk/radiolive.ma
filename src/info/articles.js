...
const SOURCES_BY_SLUG = {
  ...
  'festival-mawazine-essentiel': [
    { label: 'Le Desk — Mawazine 2026 : cinq nouveaux noms pour juin', label_ar: 'Le Desk — موازين 2026 يعلن خمسة أسماء جديدة', url: 'https://ledesk.ma/culture/mawazine-2026-le-festival-annonce-cinq-nouveaux-noms-pour-juin/' },
    { label: 'Yabiladi — Du chaabi à Salé aux concerts internationaux à Chellah', label_ar: 'Yabiladi — من الشعبي بسلا إلى الحفلات الدولية بشالة', url: 'https://www.yabiladi.com/articles/details/195795/mawazine-2026-chaabi-sale-concerts.html' },
    { label: 'L\'Observateur — Mawazine 2026 : entre soul, traditions africaines et patrimoine', label_ar: 'L\'Observateur — رحلة موسيقية بين السول والتقاليد الإفريقية والتراث', url: 'https://lobservateur.info/ampArticle/118477' },
