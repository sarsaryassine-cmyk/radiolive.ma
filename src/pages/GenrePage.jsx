  ...
  chaabi: {
    ...
    blocks: [
      ...
      },
      {
        ...
        p_ar: 'بالنسبة للجالية المغربية، الشعبي صلة مباشرة ببلد الأصل — موسيقى الأعراس العائلية والأعياد ولحظات الحياة. ويُتيح البثّ الوصول بجودة عالية إلى كل هذه المحطات من أي مكان في العالم. يجمع كتالوجنا أزيد من 30 إذاعة مغربية، ومنها أبرز إذاعات الشعبي، في تجربة عصرية وسلسة.',
      },
    ],
  },
  hit: {
    ...
    blocks: [
      ...
      },
      {
        ...
        p_ar: 'يتيح موقعنا الاستماع بجودة عالية إلى كل هذه الإذاعات الموسيقية المغربية، دون فواصل إشهارية مزعجة ودون تسجيل. ويرافق مشغّل الصوت تصفّحك ويمنحك أكثر من 30 محطة بنقرة واحدة. اكتشف أيضاً صفحتنا المخصّصة للإذاعات المغربية الأمازيغية.',
      },
    ],
  },
  amazigh: {
