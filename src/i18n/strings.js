...
export const STRINGS = {
  ...
  ar: {
    ...
    meta: {
      ...
      home_description: 'استمع إلى جميع الإذاعات المغربية مباشرة وبجودة عالية: هيت راديو، ميدي1، شدى إف إم، ميد راديو، أصوات، راديو مارس وأكثر من 50 محطة. مجاناً من المغرب أو من الخارج.',
      og_locale: 'ar_MA',
    },
