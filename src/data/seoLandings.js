...
export const SEO_LANDINGS = {
  ...
  'radio-maroc-en-direct': {
    ...
    body: [
      { h2: 'Le direct : ce que le live a de plus que la rediffusion' },
      { p: "Écouter une radio en direct n'a rien à voir avec un podcast ou une playlist. Le live porte l'émotion de l'instant : le but marqué à la 90ᵉ minute, la dédicace lue à l'antenne, le fou rire d'un animateur au petit matin, la météo avant de partir travailler. C'est ce lien immédiat avec le pays et l'instant présent qui fait la force du direct radio marocain — impossible à recréer en différé." },
      { p: "Le direct crée aussi un rendez-vous collectif : des milliers d'auditeurs vivent la même émission au même moment, à Casablanca comme à Bruxelles. Cette simultanéité est ce qui donne au live toute sa valeur, là où le replay isole chacun dans son propre créneau d'écoute." },

      { h2: 'Les grands rendez-vous du direct radio au Maroc' },
      { h3: 'Le sport en direct' },
      { p: "Le football est le premier moteur du direct. Radio Mars retransmet en live les matchs de la Botola Pro, les rencontres des Lions de l'Atlas (CAN, Coupe du monde, éliminatoires) et les grands derbies Wydad–Raja, avec multiplex et commentaires bilingues. Quand on ne peut pas regarder le match, le direct radio reste le moyen le plus vivant de le suivre, minute par minute." },
      { h3: 'Le Ramadan et les moments spirituels' },
      { p: "Pendant le Ramadan, le direct prend une dimension particulière : Radio Mohammed VI du Saint Coran et Radio Coran diffusent en temps réel les Tarawih, l'appel à la rupture du jeûne et les veillées. Chaque vendredi, les radios généralistes retransmettent l'adhan et le prêche en direct, au moment même où ils sont prononcés." },
      { h3: 'Les festivals et la culture' },
      { p: "L'été, les grands festivals — Mawazine à Rabat, Timitar à Agadir, Gnaoua à Essaouira — sont relayés en direct par les radios musicales : ambiance des scènes, interviews d'artistes en coulisses, extraits de concerts en live. Le direct devient alors la meilleure place quand on n'est pas sur site." },

      { h2: 'Le direct pour la diaspora : le pays en temps réel' },
      { p: "Pour les Marocains du monde (MRE), le direct abolit la distance. Suivre un match des Lions de l'Atlas à la même seconde que sa famille restée au bled, entendre l'ambiance d'un soir de Ramadan depuis Paris ou Montréal : c'est ce que permet le streaming en direct, sans VPN ni configuration. Le seul paramètre à gérer est le décalage horaire local — mais l'antenne, elle, reste parfaitement synchrone avec le Maroc." },

      { h2: 'Comment ne rien manquer du direct' },
      { ul: [
        "Ajoutez vos radios en favoris pour les relancer en un clic à l'heure du direct.",
        "Consultez le top des radios pour repérer les stations les plus écoutées à l'instant T.",
        "Gardez le lecteur ouvert : le flux continue même quand vous changez de page.",
        "Pour un événement précis (match, concert, discours), branchez la radio sportive ou généraliste qui le couvre en direct.",
      ]},

      { h2: 'Direct, rediffusion et podcast : quelle différence ?' },
      { p: "Le direct diffuse le programme au moment exact où il est produit ; la rediffusion rejoue une émission passée à heure fixe ; le podcast est disponible à la demande, quand vous voulez. Les trois se complètent : le direct pour l'instant présent et l'événementiel, la rediffusion pour les rendez-vous récurrents, le podcast pour rattraper à son rythme. Sur radiolive.ma, l'accent est mis sur le live — la radio dans sa forme la plus authentique." },
    ],
    faq: [
      {
        q: 'Y a-t-il un décalage sur le direct radio en ligne ?',
        a: "Oui, un léger décalage de 5 à 30 secondes selon la station et votre connexion, dû à la mise en tampon du flux. Sur la fibre il est imperceptible ; en 4G ou 5G il reste très court.",
      },
      {
        q: 'Comment suivre un match de football en direct à la radio ?',
        a: "Ouvrez Radio Mars — première radio sportive du Maroc — ou une généraliste qui couvre l'événement, puis lancez le direct. Les matchs de la Botola et des Lions de l'Atlas y sont commentés en temps réel, souvent en multiplex.",
      },
      {
        q: 'Peut-on suivre le Ramadan en direct sur la radio marocaine ?',
        a: "Oui : Radio Mohammed VI du Saint Coran, Radio Coran et Radio Manarat diffusent en direct les Tarawih, les veillées et l'appel à la rupture du jeûne pendant tout le mois.",
      },
      {
        q: 'Le direct est-il disponible depuis l\'étranger en temps réel ?',
        a: "Oui, le live est synchrone avec le Maroc partout dans le monde, sans VPN. Seul le décalage horaire local diffère : l'antenne diffusée reste la même qu'au pays, à la seconde près.",
      },
      {
        q: 'Quelle différence entre le direct et le replay ou podcast ?',
        a: "Le direct diffuse le programme au moment où il est produit ; le replay rejoue une émission passée ; le podcast est disponible à la demande. radiolive.ma met l'accent sur le direct, pour vivre la radio en temps réel.",
      },
    ],
    relatedStationIds: STATION_GROUPS.flagship,
    related: RELATED_FR,
