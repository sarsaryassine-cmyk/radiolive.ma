...
/** Traduction arabe des libellés de type de station (table fréquences). */
export const FREQ_TYPE_AR = {
  'Sport': 'رياضة',
  'Musique / Variétés': 'موسيقى / منوّعات',
  'Hip-Hop / R&B': 'هيب هوب / R&B',
  'Service public': 'خدمة عمومية',
  'Économie / Lounge': 'اقتصاد / لاونج',
  'Généraliste': 'عامة',
  'Religieuse': 'دينية',
  'Hits / Pop': 'نجاحات / بوب',
  'Variétés arabes': 'منوّعات عربية',
  'Économie / Business': 'اقتصاد / أعمال',
  'Internationale FR/AR': 'دولية فر/عر',
  'Variétés grand public': 'منوّعات عامة',
  'Afro-orientale': 'إفريقية-شرقية',
  'Régionale': 'جهوية',
  'Régionale / Amazigh': 'جهوية / أمازيغية',
  'Régionale amazighe': 'جهوية أمازيغية',
  'Andalouse': 'أندلسية',
  'Régionale rifaine': 'جهوية ريفية',
  'Régionale hassanie': 'جهوية حسانية',
  'Religieuse / Culturelle': 'دينية / ثقافية',
};

/** Nom AR, région AR et intro AR par ville (fallback FR si absent). */
export const FREQ_CITY_AR = {
  casablanca: { name: 'الدار البيضاء', region: 'الدار البيضاء-سطات', intro: 'الدار البيضاء هي العاصمة الاقتصادية للمغرب والقلب النابض للمشهد الإذاعي الوطني. تتّخذ أغلب كبرى الإذاعات الخاصة منها مقرّاً لأستوديوهاتها الرئيسية وتبثّ بها تردداتها الأقوى، التي تُلتقط في كامل الدار البيضاء الكبرى من المحمدية إلى بوسكورة.' },
  rabat: { name: 'الرباط', region: 'الرباط-سلا-القنيطرة', intro: 'الرباط هي العاصمة السياسية والإدارية للمغرب، ويعكس مشهدها الإذاعي دورها المؤسّساتي. بها توجد المقرّات التاريخية لـSNRT والهاكا (HACA)، إضافة إلى الأستوديوهات الرئيسية لعدة إذاعات عمومية.' },
  marrakech: { name: 'مراكش', region: 'مراكش-آسفي', intro: 'مراكش، المدينة الحمراء، تستقبل ملايين السياح سنويّاً وتتوفّر على مشهد إذاعي خاص حيث تتجاور الإذاعة الجهوية مراكش بلوس مع كبرى القنوات الوطنية. تعيش المدينة أيضاً على إيقاع المهرجانات الكبرى (المهرجان الدولي للفيلم) التي تُعبّئ الإذاعات.' },
  fes: { name: 'فاس', region: 'فاس-مكناس', intro: 'فاس، العاصمة الروحية والثقافية للمغرب المؤسَّسة سنة 789 والحاضنة لإحدى أقدم الجامعات في العالم (القرويين)، تعيش على إيقاع إذاعي يطبعه البُعد الديني والأندلسي والأكاديمي. تُستمع بها الإذاعات القرآنية بكثرة، إلى جانب برامج التراث الموسيقي العربي-الأندلسي.' },
  tanger: { name: 'طنجة', region: 'طنجة-تطوان-الحسيمة', intro: 'طنجة مرتبطة وثيق الارتباط بتاريخ الإذاعة المغربية — ففي هذه المدينة-العالم بالشمال، ملتقى إفريقيا وأوروبا، تأسست ميدي1 راديو سنة 1980 ولها بها مقرّها التاريخي. وطنجة من المدن القليلة التي تلتقط بسهولة الإذاعات الإسبانية عبر مضيق جبل طارق.' },
  agadir: { name: 'أكادير', region: 'سوس-ماسة', intro: 'أكادير، عاصمة سوس والمدينة الشاطئية الكبرى، تتوفّر على مشهد إذاعي جهوي قوي بهوية أمازيغية-تاشلحيت بارزة. تبثّ بها عدة إذاعات بالتاشلحيت إلى جانب القنوات الوطنية الكبرى. ويُعبّئ مهرجان تيميتار للموسيقى الأمازيغية، المنظَّم كل صيف، جميع الهوائيات.' },
  oujda: { name: 'وجدة', region: 'الجهة الشرقية', intro: 'وجدة، عاصمة الجهة الشرقية، تعبرها الموجات المغربية وأيضاً الجزائرية — خصوصية جغرافية فريدة بالمغرب. يستمع سكانها، الموزَّعون بين الثقافتين العربية والأمازيغية-الريفية، إلى الإذاعات الوطنية كما إلى برامج ميدي1 الفرنكوفونية وترددات الراي الشهيرة.' },
  meknes: { name: 'مكناس', region: 'فاس-مكناس', intro: 'مكناس، إحدى المدن الإمبراطورية الأربع بالمغرب، تتقاسم مشهدها الإذاعي مع جارتها فاس. تستفيد المدينة من تغطية FM جيدة لكبرى الإذاعات الوطنية والخاصة، إضافة إلى الترددات الجهوية لشمال-شرق المغرب.' },
  kenitra: { name: 'القنيطرة', region: 'الرباط-سلا-القنيطرة', intro: 'القنيطرة، الميناء الأطلسي شمال الرباط، تلتقط أغلب ترددات العاصمة بفضل قربها الجغرافي. ومع ذلك تتوفّر على مرحّلات محلية لبعض الإذاعات الوطنية، ويستمع جمهورها أساساً للبرامج بالدارجة والعربية الفصحى.' },
  tetouan: { name: 'تطوان', region: 'طنجة-تطوان-الحسيمة', intro: 'تطوان، إحدى كبرى المدن الأندلسية بالمغرب والعاصمة التاريخية للموسيقى العربية-الأندلسية، تعيش في فلك طنجة الإذاعي. ويبقى معهد الموسيقى الأندلسية بتطوان مرجعاً عالميّاً، وتخصّص له عدة إذاعات فقرات خاصة.' },
  'el-jadida': { name: 'الجديدة', region: 'الدار البيضاء-سطات', intro: 'الجديدة، الميناء الأطلسي جنوب الدار البيضاء، تلتقط أغلب ترددات العاصمة الاقتصادية بفضل قربها. مدينة تاريخية مصنّفة تراثاً عالميّاً لليونسكو بمدينتها البرتغالية، وتحتضن سنويّاً مهرجان جوهرة الذي يُعبّئ الإذاعات المغربية.' },
  safi: { name: 'آسفي', region: 'مراكش-آسفي', intro: 'آسفي، الميناء الأطلسي المعروف بفخّاره التقليدي وصناعته الفوسفاطية، يتوفّر على مشهد إذاعي متكامل نسبيّاً بتغطية جيدة للقنوات الوطنية وعدة مرحّلات جهوية. وجهة دكالة-عبدة، التي تنتمي إليها آسفي، مهد العيطة — أحد أنواع الشعبي التقليدي.' },
  'beni-mellal': { name: 'بني ملال', region: 'بني ملال-خنيفرة', intro: 'بني ملال، عاصمة جهة تادلة الفلاحية، تحيط بها قرى أمازيغية بالأطلس المتوسط. يعكس مشهدها الإذاعي هذه الثنائية اللغوية — الدارجة في المدينة والتمازيغت في القرى المجاورة. وتبثّ عدة إذاعات محلية بفروع أمازيغية من الأطلس المتوسط.' },
  khouribga: { name: 'خريبكة', region: 'بني ملال-خنيفرة', intro: 'خريبكة، العاصمة العالمية للفوسفاط ومقرّ المكتب الشريف للفوسفاط (OCP) التاريخي، تتوفّر على مشهد إذاعي متأثّر بساكنتها العمالية والصناعية. ويُعبّئ المهرجان الدولي لسينما إفريقيا بخريبكة، المنظَّم سنويّاً، الهوائيات المحلية.' },
  nador: { name: 'الناظور', region: 'الجهة الشرقية', intro: 'الناظور، المدينة الريفية بشمال-شرق المغرب، هي القطب الجهوي الكبير للثقافة الأمازيغية-الريفية (التاريفيت). ترتبط ساكنتها بروابط قوية مع الجالية المغربية ببلجيكا وهولندا وألمانيا. وتبثّ عدة إذاعات بالتاريفيت والعربية، كما تلتقط المدينة الإذاعات الإسبانية بمليلية المجاورة.' },
  laayoune: { name: 'العيون', region: 'العيون-الساقية الحمراء', intro: 'العيون، عاصمة الأقاليم الجنوبية للمغرب، تتوفّر على مشهد إذاعي خاص يعكس الهوية الحسانية للجهة. تشغّل SNRT بها إذاعة جهوية مخصّصة بالحسانية والعربية، وتغطّي القنوات الوطنية الكبرى المدينة عبر المرحّلات.' },
};
